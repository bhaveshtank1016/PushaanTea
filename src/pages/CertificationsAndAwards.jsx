  ...
  return (
    <section className="bg-[#66656365] text-black py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto text-center">
        ...
        <p className="mb-10 text-black text-sm sm:text-base">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
          {certifications.map((item, index) => (
            <div
              key={index}
              className="bg-[#F5F7FA]   rounded-xl p-6 flex flex-col items-center text-center hover:shadow-lg transition-all duration-300 hover:-translate-y-1"
            >
              {item.icon}
