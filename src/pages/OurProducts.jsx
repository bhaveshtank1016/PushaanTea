...
const teas = [
  {
    ...
    reviews: 58,
    image:
      "https://tealeavz.com/cdn/shop/articles/what-does-black-tea-taste-like.jpg?v=1659743106", // Replace with actual path
  },
  {
    id: 2,
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1  sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
          {teas.map((tea) => (
            <div
              key={tea.id}
              className="border rounded-md p-4 bg-[#67707e] text-center shadow-sm hover:shadow-orange-700 hover:shadow-xl transition"
            >
              <img
                src={tea.image}
                alt={tea.name}
